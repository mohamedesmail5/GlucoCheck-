...
if __name__ == "__main__":
    ...
    if os.path.exists("data/diabetes_dataset.csv"):
        df = pd.read_csv("data/diabetes_dataset.csv")
        print(f"Loaded pre-built dataset: {len(df)} records")
    else:
    ...
    print(f"  Demo users seeded in Supabase")
    print(f"  Run: python ../ml/train_text_model.py --data data/training_data.csv")
    print("=" * 60)
